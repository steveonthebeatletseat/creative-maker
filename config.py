...
PHASE1_MIN_DOMINANT_EMOTIONS = int(os.getenv("PHASE1_MIN_DOMINANT_EMOTIONS", "3"))
PHASE1_MIN_HIGH_CONF_EMOTIONS = int(os.getenv("PHASE1_MIN_HIGH_CONF_EMOTIONS", "2"))
...
PHASE3_V2_HOOK_CANDIDATES_PER_UNIT = max(
    1,
    int(os.getenv("PHASE3_V2_HOOK_CANDIDATES_PER_UNIT", "10")),
)
...
PHASE3_V2_SCENE_ENABLE_BEAT_SPLIT = (
    os.getenv("PHASE3_V2_SCENE_ENABLE_BEAT_SPLIT", "true").strip().lower()
    in {"1", "true", "yes", "on"}
)
PHASE3_V2_SCENE_BEAT_TARGET_WORDS_MIN = max(
    1,
    int(os.getenv("PHASE3_V2_SCENE_BEAT_TARGET_WORDS_MIN", "10")),
)
PHASE3_V2_SCENE_BEAT_TARGET_WORDS_MAX = max(
    int(PHASE3_V2_SCENE_BEAT_TARGET_WORDS_MIN),
    int(os.getenv("PHASE3_V2_SCENE_BEAT_TARGET_WORDS_MAX", "18")),
)
PHASE3_V2_SCENE_BEAT_HARD_MAX_WORDS = max(
    int(PHASE3_V2_SCENE_BEAT_TARGET_WORDS_MAX),
    int(os.getenv("PHASE3_V2_SCENE_BEAT_HARD_MAX_WORDS", "24")),
)
PHASE3_V2_SCENE_MAX_BEATS_PER_LINE = max(
    1,
    int(os.getenv("PHASE3_V2_SCENE_MAX_BEATS_PER_LINE", "3")),
)
PHASE3_V2_SCENE_BEAT_MIN_WORDS = max(
    1,
    int(os.getenv("PHASE3_V2_SCENE_BEAT_MIN_WORDS", "6")),
)
